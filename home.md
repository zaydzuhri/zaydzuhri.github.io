...
[zaydzuhri[AT]gmail[DOT]com](mailto:zaydzuhri@gmail.com)
...
### long-term interests
- Alternative language model architectures (Deep in my heart I think constant state size models are the way to go, AGI shouldn't have a KV cache lol. Either that or parametric memory, but we'll see)
- Continual learning
- Continual inference(?)

## research
- (august 2025, ICML 2026) [Predicting the order of upcoming tokens improves language modeling](https://arxiv.org/abs/2508.19228)
- (april 2025, ACL 2026 Findings) [Softpick: No Attention Sink, No Massive Activations with Rectified Softmax](https://arxiv.org/abs/2504.20966)
